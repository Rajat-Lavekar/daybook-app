...
- PrivateData, build products, SwiftPM state and personal Xcode state remain ignored and are excluded from the initial source commit. No physical-phone deployment was performed.
